...
#change column name, data type and constraints
...
#add foreign key
ALTER TABLE _regions ADD INDEX fk_regions_countries_idx (country_id ASC) VISIBLE;
ALTER TABLE _regions ADD CONSTRAINT fk_regions_countries FOREIGN KEY (country_id) REFERENCES _countries (id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE _cities ADD INDEX fk_cities_countries_idx (country_id ASC) VISIBLE;
ALTER TABLE _cities ADD CONSTRAINT fk_cities_countries FOREIGN KEY (country_id) REFERENCES _countries (id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE _cities ADD INDEX fk_cities_regions_idx (region_id ASC) VISIBLE;
ALTER TABLE _cities ADD CONSTRAINT fk_cities_regions FOREIGN KEY (region_id) REFERENCES _regions (id) ON DELETE NO ACTION ON UPDATE NO ACTION;